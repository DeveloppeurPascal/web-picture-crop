...
function fnResizeDiv()
{
	...
	if(vgCurrentWidth <= vgConteneurWidth && vgCurrentWidth * ratio <= vgConteneurHeight + 1 && vgCurrentWidth >= MinWidth && vgCurrentWidth * ratio >= MinHeight) {
	...
	document.getElementById('bloc_recadre_haut').style.left = vgConteneurX;
	document.getElementById('bloc_recadre_haut').style.top = vgConteneurY;
	document.getElementById('bloc_recadre_haut').style.width = vgConteneurWidth +1;
	if (PositionY - vgConteneurY > 0)
		document.getElementById('bloc_recadre_haut').style.height = PositionY - vgConteneurY;
	else
		document.getElementById('bloc_recadre_haut').style.height = 0;

	document.getElementById('bloc_recadre_gauche').style.left = vgConteneurX;
	document.getElementById('bloc_recadre_gauche').style.top = PositionY;
	if (PositionX - vgConteneurX > 0)
		document.getElementById('bloc_recadre_gauche').style.width = PositionX - vgConteneurX;
	else
		document.getElementById('bloc_recadre_gauche').style.width = 0;
	document.getElementById('bloc_recadre_gauche').style.height = TailleY;

	document.getElementById('bloc_recadre_bas').style.left = vgConteneurX;
	document.getElementById('bloc_recadre_bas').style.top = PositionY + TailleY;
	document.getElementById('bloc_recadre_bas').style.width = vgConteneurWidth +1;
	if (vgConteneurY + vgConteneurHeight - PositionY - TailleY > 0)
		document.getElementById('bloc_recadre_bas').style.height = vgConteneurY + vgConteneurHeight - PositionY - TailleY +1;
	else
		document.getElementById('bloc_recadre_bas').style.height = 0;

	document.getElementById('bloc_recadre_droite').style.left = PositionX + TailleX;
	document.getElementById('bloc_recadre_droite').style.top = PositionY;
	if (vgConteneurWidth - TailleX + vgConteneurX - PositionX > 0)
		document.getElementById('bloc_recadre_droite').style.width = vgConteneurWidth - TailleX + vgConteneurX - PositionX +1;
	else
		document.getElementById('bloc_recadre_droite').style.width = 0;
	document.getElementById('bloc_recadre_droite').style.height = TailleY;
...
function fnOnLoad()
{
	...
	MinWidth = document.getElementById('mx').value;
	MinHeight = document.getElementById('my').value;
	document.getElementById('bloc_recadre').style.width = document.getElementById('gx').value;
	document.getElementById('bloc_recadre').style.height = document.getElementById('gy').value;
/*	document.getElementById('bloc_recadre').style.left = document.getElementById('conteneur').style.left;
	document.getElementById('bloc_recadre').style.top = document.getElementById('conteneur').style.top;*/
}
